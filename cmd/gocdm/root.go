...
import (
	...
	"github.com/arran4/gocdm/cmd/gocdm/templates"
)
...
func NewRoot(name, version, commit, date string) (*RootCmd, error) {
	...
	c.BoolVar(&c.dryRun, "dry-run", false, "Dry run mode emulate")
	c.BoolVar(&c.dryRun, "n", false, "Dry run mode emulate")

	c.BoolVar(&c.forceMenu, "menu", false, "Force menu display")
	c.BoolVar(&c.forceMenu, "m", false, "Force menu display")

	c.CommandAction = func(c *RootCmd) error {

		Run(c.dryRun, c.forceMenu, c.args...)
		return nil
	}
...
func (c *RootCmd) Execute(args []string) error {
	...
	if c.CommandAction != nil {
		if err := c.CommandAction(c); err != nil {
			return fmt.Errorf("gocdm failed: %w", err)
		}
	}
	return nil
}
